...
export default function Home() {
  ...
  return (
    <div className="text-gray-800">
      ...
      >
        <div className="flex font-bold uppercase justify-center mt-20 lg:mt-24 xl:mb-16 mb-16 lg:mb-12 text-2xl lg:text-2xl text-gray-600">
          What We Do
        </div>
        ...
        <div className="xl:flex">
          ...
          <div className="flex pl-10 my-3 md:my-5 md:justify-center xl:w-1/3">
            <div>
              <Image src={PM} height={80} width={80} alt="project management" />
            </div>
            <div className="flex flex-col w-2/3 md:w-full pr-3 pl-1 md:pl-3">
              <div className="text-teal-600 text-xl md:text-2xl lg:text-xl font-semibold mb-2">
                Project Management
      ...
      <div className="flex lg:hidden">
        <Image src={taliAfrica} alt="tali footprint" />
      </div>
